...
function TypeIcon({ type }: { type: SearchResult["type"] }) {
  if (type === "minister")
    return (
      <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#0EA5E9]/10 text-blue-700 font-bold text-sm">
        म
      </span>
    );
  if (type === "manifesto")
    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-neutral-200 bg-white py-3 pl-11 pr-4 text-sm text-neutral-800 shadow-sm outline-none transition focus:border-blue-700 focus:ring-2 focus:ring-[#0EA5E9]/10"
        />
        {loading && (
