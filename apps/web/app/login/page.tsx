          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-neutral-300 px-3 py-2 text-sm text-neutral-800 outline-none focus:border-blue-700 focus:ring-2 focus:ring-[#0EA5E9]/20"
              />
            </div>
